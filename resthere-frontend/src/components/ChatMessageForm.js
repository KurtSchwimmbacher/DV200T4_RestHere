...
const ChatMessageForm = ({ professional }) => { 
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${process.env.REACT_APP_API_URL}/api/chat/send`, {
                sender: user.userID, 
    ...
    const fetchMessages = useCallback(async () => {
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/chat/${user.userID}/${professional._id}`);
